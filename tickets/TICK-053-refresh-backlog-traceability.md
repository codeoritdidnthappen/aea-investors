...
54 ticket files exist. The highest ID the backlog mentions anywhere is
TICK-031. These 25 are absent entirely:
...
TICK-051, TICK-052, TICK-053, TICK-054
```
...
anything untraced" gets an answer that is wrong by 25 tickets, and the
...
-- run it against the current tree and confirm it goes from failing (25
