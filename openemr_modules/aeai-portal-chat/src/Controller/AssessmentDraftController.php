    ...
    public function addRoutes(RestApiCreateEvent $event): RestApiCreateEvent
    {
        $event->addToPortalRouteMap(
            ...
            function (HttpRestRequest $request) {
                // HttpRestRequest::getRequestBodyJSON() calls ->getContents() on a raw
                // PHP resource in this OpenEMR version and fatals; every core route
                // reads the body this way instead (see e.g.
